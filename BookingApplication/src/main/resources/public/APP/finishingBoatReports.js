Vue.component("FinishingBoatReports", {
    data: function() {
        return {
            appointments: "",
            client: "",
    ...
    methods: {
        ...
        if (this.validateReport()) {
          ...
          axios
          .post("reports/sendBoatReport/",  this.report, {
                headers: {
        ...
        refreshAppointments() {
        	axios
            .get("boatAppointments/getReservationsForReports/" + this.activeUser.id)
        ...
        rememberAppointment(app) {
          ...
          this.report.ownerId = app.boat.shipOwner.id;
        },
