Vue.component("BoatProfitGraph", {
	...
	weekFormat() {
	    ...
	    axios
        	.get('/boatAppointments/getBoatProfitChartsWeek/' + instructorsId)
	        .then(response => {
	...
	monthFormat() {
		instructorsId = this.activeUser.id 
        axios
        	.get('/boatAppointments/getBoatProfitChartsMonth/' + instructorsId)
	        .then(response => {
	        this.chartInfo = response.data
	        console.log(this.chartInfo)
			this.renderChart(this.makeSeries(this.chartInfo));
	...
	yearFormat() {
		instructorsId = this.activeUser.id 
        axios
        	.get('/boatAppointments/getBoatProfitChartsYear/' + instructorsId)
	        .then(response => {
	        this.chartInfo = response.data
	        console.log(this.chartInfo)
			this.renderChart(this.makeSeries(this.chartInfo));
	...
	allFormat() {
		instructorsId = this.activeUser.id 
        axios
        	.get('/boatAppointments/getBoatProfitCharts/' + instructorsId)
	        .then(response => {
	        this.chartInfo = response.data
	        console.log(this.chartInfo)
			this.renderChart(this.makeSeries(this.chartInfo));
