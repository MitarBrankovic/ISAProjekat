...
insert into app_user (id, name, surname, email, password, address, city, country, phone_number, role, verified, ROLES_id) values ( nextval('my_user_seq'), 'Rale', 'Rale', 'rale@gmail.com', '111','Palih studenata 2', 'Novi Sad', 'Serbia', '12312312', 'ship_owner', true, 3);
...
insert into cottage_appointment (id, appointment_start, duration, max_amount_of_people, appointment_type,  extra_notes, price, owner_profit, system_profit, cottage_id, client_id) values ( nextval('cottage_appointment_seq_gen'), '2022-01-10 12:00:00', 4, 5, 'quick', 'Nema dodatnih informacija', 5000, 1000, 4000, 1, 1);
insert into cottage_appointment (id, appointment_start, duration, max_amount_of_people, appointment_type,  extra_notes, price, owner_profit, system_profit, cottage_id, client_id) values ( nextval('cottage_appointment_seq_gen'), '2022-12-25 12:00:00', 2, 5, 'quick', 'Nema dodatnih informacija', 2500, 500, 2000, 2, 1);
insert into cottage_appointment (id, appointment_start, duration, max_amount_of_people, appointment_type,  extra_notes, price, owner_profit, system_profit, cottage_id, client_id) values ( nextval('cottage_appointment_seq_gen'), '2022-12-26 12:00:00', 3, 5, 'quick', 'Nema dodatnih informacija', 2500, 500, 2000, 2, null);
insert into cottage_appointment (id, appointment_start, duration, max_amount_of_people, appointment_type,  extra_notes, price, owner_profit, system_profit, cottage_id, client_id) values ( nextval('cottage_appointment_seq_gen'), '2021-12-28 12:00:00', 4, 5, 'regular', 'Nema dodatnih informacija', 2500, 500, 2000, 1, 2);
insert into cottage_appointment (id, appointment_start, duration, max_amount_of_people, appointment_type,  extra_notes, price, owner_profit, system_profit, cottage_id, client_id) values ( nextval('cottage_appointment_seq_gen'), '2019-12-28 12:00:00', 4, 5, 'regular', 'Nema dodatnih informacija', 3200, 640, 2560, 1, 1);

insert into boat_appointment (id, appointment_start, duration, max_amount_of_people, appointment_type,  extra_notes, price, owner_profit, system_profit, boat_id, client_id) values ( nextval('cottage_appointment_seq_gen'), '2022-12-20 12:00:00', 4, 5, 'quick', 'Nema dodatnih informacija', 3000, 600, 2400, 5, 1);
insert into boat_appointment (id, appointment_start, duration, max_amount_of_people, appointment_type,  extra_notes, price, owner_profit, system_profit, boat_id, client_id) values ( nextval('cottage_appointment_seq_gen'), '2022-12-28 12:00:00', 4, 5, 'quick', 'Nema dodatnih informacija', 2500, 500, 2000, 5, 1);
insert into boat_appointment (id, appointment_start, duration, max_amount_of_people, appointment_type,  extra_notes, price, owner_profit, system_profit, boat_id, client_id) values ( nextval('cottage_appointment_seq_gen'), '2022-12-28 12:00:00', 4, 5, 'quick', 'Nema dodatnih informacija', 2500, 500, 2000, 5, null);
insert into boat_appointment (id, appointment_start, duration, max_amount_of_people, appointment_type,  extra_notes, price, owner_profit, system_profit, boat_id, client_id) values ( nextval('cottage_appointment_seq_gen'), '2021-12-28 12:00:00', 4, 5, 'regular', 'Nema dodatnih informacija', 2500, 500, 2000, 1, 1);
insert into boat_appointment (id, appointment_start, duration, max_amount_of_people, appointment_type,  extra_notes, price, owner_profit, system_profit, boat_id, client_id) values ( nextval('cottage_appointment_seq_gen'), '2019-12-28 12:00:00', 4, 5, 'regular', 'Nema dodatnih informacija', 3200, 640, 2560, 1, 1);
...
insert into fishing_appointment (id, appointment_start, address, city, duration, max_amount_of_people, appointment_type, available, rating, extra_notes, price, instructor_profit, system_profit, fishing_adventure_id, client_id) values ( nextval('fishing_appointment_seq_gen'), '2022-01-04 12:00:00', 'Palicka, 43', 'Subotica', 4, 8, 'regular', true, 0, 'Nema dodatnih informacija', 2500, 500, 2000, 1, 1);
insert into fishing_appointment (id, appointment_start, address, city, duration, max_amount_of_people, appointment_type, available, rating, extra_notes, price, instructor_profit, system_profit, fishing_adventure_id, client_id) values ( nextval('fishing_appointment_seq_gen'), '2022-12-25 12:00:00', 'Palicka, 43', 'Subotica', 4, 7, 'quick', true, 0, 'Nema dodatnih informacija', 2500, 500, 2000, 1, 1);
insert into fishing_appointment (id, appointment_start, address, city, duration, max_amount_of_people, appointment_type, available, rating, extra_notes, price, instructor_profit, system_profit, fishing_adventure_id, client_id) values ( nextval('fishing_appointment_seq_gen'), '2021-12-22 12:00:00', 'Palicka, 43', 'Subotica', 4, 6, 'quick', true, 0, 'Nema dodatnih informacija', 2500, 500, 2000, 1, null);
insert into fishing_appointment (id, appointment_start, address, city, duration, max_amount_of_people, appointment_type, available, rating, extra_notes, price, instructor_profit, system_profit, fishing_adventure_id, client_id) values ( nextval('fishing_appointment_seq_gen'), '2021-12-23 12:00:00', 'Palicka, 43', 'Subotica', 4, 5, 'regular', true, 0, 'Nema dodatnih informacija', 2500, 500, 2000, 1, 2);
insert into fishing_appointment (id, appointment_start, address, city, duration, max_amount_of_people, appointment_type, available, rating, extra_notes, price, instructor_profit, system_profit, fishing_adventure_id, client_id) values ( nextval('fishing_appointment_seq_gen'), '2019-12-23 12:00:00', 'Palicka, 43', 'Subotica', 4, 5, 'regular', true, 0, 'Nema dodatnih informacija', 3200, 640, 2560, 2, 1);
insert into fishing_appointment (id, appointment_start, address, city, duration, max_amount_of_people, appointment_type, available, rating, extra_notes, price, instructor_profit, system_profit, fishing_adventure_id, client_id) values ( nextval('fishing_appointment_seq_gen'), '2022-01-09 12:00:00', 'Palicka, 43', 'Subotica', 96, 7, 'quick', true, 0, 'Nema dodatnih informacija', 2500, 500, 2000, 1, 1);
