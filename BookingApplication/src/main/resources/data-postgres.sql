...
insert into cottage_appointment (id, appointment_start, duration, max_amount_of_people, appointment_type,  extra_notes, price, cottage_id, client_id) values ( nextval('cottage_appointment_seq_gen'), '2021-12-23 12:00:00', 4, 5, 'quick', 'Nema dodatnih informacija', 5000, 1, null);
insert into cottage_appointment (id, appointment_start, duration, max_amount_of_people, appointment_type,  extra_notes, price, cottage_id, client_id) values ( nextval('cottage_appointment_seq_gen'), '2021-12-25 12:00:00', 2, 5, 'quick', 'Nema dodatnih informacija', 2500, 2, null);
...
insert into boat_appointment (id, appointment_start, duration, max_amount_of_people, appointment_type,  extra_notes, price, boat_id, client_id) values ( nextval('cottage_appointment_seq_gen'), '2021-12-28 12:00:00', 4, 5, 'quick', 'Nema dodatnih informacija', 3000, 5, null);
...
insert into fishing_appointment (id, appointment_start, address, city, duration, max_amount_of_people, appointment_type, available, extra_notes, price, fishing_adventure_id, client_id) values ( nextval('fishing_appointment_seq_gen'), '2021-12-21 12:00:00', 'Palicka, 43', 'Subotica', 4, 7, 'quick', true, 'Nema dodatnih informacija', 2500, 1, null);
