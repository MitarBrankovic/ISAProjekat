Vue.component("FinishingCottageReports", {
    data: function() {
        return {
            appointments: "",
            client: "",
    ...
    methods: {
        ...
        if (this.validateReport()) {
          ...
          axios
          .post("reports/sendCottageReport/",  this.report, {
                headers: {
        ...
        refreshAppointments() {
        	axios
            .get("cottageAppointments/getReservationsForReports/" + this.activeUser.id)
        ...
        rememberAppointment(app) {
          ...
          this.report.ownerId = app.cottage.cottageOwner.id;
        },
