Vue.component("CurrentFishingAppointments", {
    data: function() {
        return {
            dateTimeNow: new Date(),
            appointments: "",
            newAppointment: {dateFrom: "", timeFrom: "8:00", dateUntil: "", timeUntil: "12:00", extraNotes: "", price: 100, adventureId: 0, clientId: ""},
            adventures: "",
        }
    },
    template :`
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
            	<div class="row my-row" style="margin-top: 2%;">
            		...
            		<select class="form-select" v-model="newAppointment.adventureId" aria-label="Example select with button addon">
			                  <option v-for="adventure in adventures" :value="adventure.id">{{adventure.name}} - {{adventure.address}}, {{adventure.city}}</option>
			                </select>
            	</div>
                <div class="row my-row" style="margin-top: 2%;">
    ...
    mounted() {
        ...
        if(this.activeUser.role != 'fishing_instructor')
         ...
         axios
            .get("fishingAppointments/getCurrentAppointments/" + this.activeUser.id)
        ...
        axios
        	.get('/fishingAdventures/getFishingInstructorsAdventures/' + this.activeUser.id)
	        .then(response => (
