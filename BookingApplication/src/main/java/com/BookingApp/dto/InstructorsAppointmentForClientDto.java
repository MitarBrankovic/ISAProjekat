...
public class InstructorsAppointmentForClientDto {
	...
	public InstructorsAppointmentForClientDto() {}
	
	public InstructorsAppointmentForClientDto(String dateFrom, String timeFrom, String dateUntil, String timeUntil, String extraNotes, double price, long adventureId, long clientId) {
		super();
