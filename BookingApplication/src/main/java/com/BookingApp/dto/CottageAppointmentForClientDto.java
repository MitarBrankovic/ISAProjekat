...
public class CottageAppointmentForClientDto {
	...
	public CottageAppointmentForClientDto() {}
	
	public CottageAppointmentForClientDto(String dateFrom, String timeFrom, String dateUntil, String timeUntil, String extraNotes, double price, long cottageId, long clientId) {
		super();
