	...
	<div>    
		<form id="registrationForm" method ="POST" @submit.prevent = "submitForm">
		  	<div class="container">
			    ...
			    <input name="nameInput" pattern="[a-zA-Z]+" oninvalid="setCustomValidity('Please enter on letters only.')" class="col-sm-2 col-form-control" type="text" v-model="name" required>
				<br>
				
				<label class="col-sm-2 col-form-label" for="surname"><b>Surname</b></label>
			    <input pattern="[a-zA-Z]+" oninvalid="setCustomValidity('Please enter on letters only.')" class="col-sm-2 col-form-control" type="text" v-model="surname" required>
				<br>
				
				
				<label class="col-sm-2 col-form-label" for="email"><b>Email</b></label>
			    <input class="col-sm-2 col-form-control" type="email" v-model="email" required>
				<br>


                <label class="col-sm-2 col-form-label" for="password"><b>Password</b></label>
			    <input id="password" class="col-sm-2 col-form-control" type="password" v-model="password" @change='check_pass()' required>
				<br>
			    ...
			    <input pattern="[a-zA-Z]+" oninvalid="setCustomValidity('Please enter on letters only.')" class="col-sm-2 col-form-control" type="text" v-model="city" required>
				<br>
                
                <label class="col-sm-2 col-form-label" for="country"><b>Country</b></label>
			    <input pattern="[a-zA-Z]+" oninvalid="setCustomValidity('Please enter on letters only.')" class="col-sm-2 col-form-control" type="text" v-model="country" required>
				<br>

                <label class="col-sm-2 col-form-label" for="phoneNumber"><b>PhoneNumber</b></label>
			    <input pattern="[0-9]+" oninvalid="setCustomValidity('Please enter on numbers only.')" class="col-sm-2 col-form-control" type="text" v-model="phoneNumber" required>
				<br>
