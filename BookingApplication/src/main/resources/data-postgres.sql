...
insert into boat_appointment (id, appointment_start, duration, max_amount_of_people, appointment_type,  extra_notes, price, boat_id, client_id) values ( nextval('boat_appointment_seq_gen'), '2022-01-10 12:00:00', 4, 5, 'quick', 'Nema dodatnih informacija', 3000, 5, 1);
insert into boat_appointment (id, appointment_start, duration, max_amount_of_people, appointment_type,  extra_notes, price, boat_id, client_id) values ( nextval('boat_appointment_seq_gen'), '2022-12-28 12:00:00', 4, 5, 'quick', 'Nema dodatnih informacija', 2500, 5, 1);
insert into boat_appointment (id, appointment_start, duration, max_amount_of_people, appointment_type,  extra_notes, price, boat_id, client_id) values ( nextval('boat_appointment_seq_gen'), '2022-12-28 12:00:00', 4, 5, 'quick', 'Nema dodatnih informacija', 2500, 5, null);
insert into boat_appointment (id, appointment_start, duration, max_amount_of_people, appointment_type,  extra_notes, price, boat_id, client_id) values ( nextval('boat_appointment_seq_gen'), '2021-12-28 12:00:00', 4, 5, 'regular', 'Nema dodatnih informacija', 2500, 1, 1);
insert into boat_appointment (id, appointment_start, duration, max_amount_of_people, appointment_type,  extra_notes, price, boat_id, client_id) values ( nextval('boat_appointment_seq_gen'), '2019-12-28 12:00:00', 4, 5, 'regular', 'Nema dodatnih informacija', 3200, 1, 1);
