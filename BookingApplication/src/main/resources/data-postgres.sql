...
insert into app_user (id, name, surname, email, password, address, city, country, phone_number, role, verified, loyalty_points, loyalty_status) values ( nextval('my_user_seq'), 'Mirko', 'Mrkva', 'mrki@gmail.com', '111','Palih studenata 2', 'Novi Sad', 'Serbia', '12312312', 'client', true, 0, 'bronze');
insert into app_user (id, name, surname, email, password, address, city, country, phone_number, role, verified, loyalty_points, loyalty_status) values ( nextval('my_user_seq'), 'Dare', 'Dare', 'dare@gmail.com', '111','Palih studenata 2', 'Novi Sad', 'Serbia', '12312312', 'client', true, 0, 'bronze');
insert into app_user (id, name, surname, email, password, address, city, country, phone_number, role, verified, loyalty_points, loyalty_status) values ( nextval('my_user_seq'), 'Kale', 'Kale', 'kale@gmail.com', '111','Palih studenata 2', 'Novi Sad', 'Serbia', '12312312', 'cottage_owner', true, 0, 'bronze');
insert into app_user (id, name, surname, email, password, address, city, country, phone_number, role, verified, loyalty_points, loyalty_status) values ( nextval('my_user_seq'), 'Rale', 'Rale', 'rale@gmail.com', '111','Palih studenata 2', 'Novi Sad', 'Serbia', '12312312', 'ship_owner', true, 0, 'bronze');
insert into app_user (id, name, surname, email, password, address, city, country, phone_number, role, verified, loyalty_points, loyalty_status) values ( nextval('my_user_seq'), 'Zare', 'Zare', 'zare@gmail.com', '111','Palih studenata 2', 'Novi Sad', 'Serbia', '12312312', 'fishing_instructor', true, 0, 'bronze');
insert into app_user (id, name, surname, email, password, address, city, country, phone_number, role, verified, loyalty_points, loyalty_status) values ( nextval('my_user_seq'), 'Mare', 'Mare', 'mare@gmail.com', '111','Palih studenata 2', 'Novi Sad', 'Serbia', '12312312', 'fishing_instructor', true, 0, 'bronze');
insert into app_user (id, name, surname, email, password, address, city, country, phone_number, role, verified, loyalty_points, loyalty_status) values ( nextval('my_user_seq'), 'Admin', 'Admin', 'admin@gmail.com', '111','Palih studenata 2', 'Novi Sad', 'Serbia', '1212312', 'admin', true, 0, 'bronze');
...
insert into boat (id, name, boat_type, length, engine_number, engine_power,max_speed, navigation_equipment, address, description, capacity, rules, fishing_equipment, price_list, price_per_hour, cancellation_terms, ship_owner_id, rating ) values ( nextval('boat_seq_gen'), 'Titanik', 'Krstarica',120.0, '123DSAWE32', 75, 30.0, 'Gps', 'Bore Tirica 89', 'NAjjaci brod',50, 'Ne skaci sa broda', 'Stap za pecanje', 'votkica - 200 din', 300, 'free_cancellation',4, 3);
insert into boat (id, name, boat_type, length, engine_number, engine_power,max_speed, navigation_equipment, address, description, capacity, rules, fishing_equipment, price_list, price_per_hour, cancellation_terms, ship_owner_id, rating ) values ( nextval('boat_seq_gen'), 'Brod 2', 'Camac',50.0, '213dasdda', 10, 50.0, 'Radio', 'Bore Tirica 90', 'Camac za bleju',50, 'Ne skaci sa broda', 'Stap za pecanje', 'votkica - 200 din', 410, 'free_cancellation',4, 4);
insert into boat (id, name, boat_type, length, engine_number, engine_power,max_speed, navigation_equipment, address, description, capacity, rules, fishing_equipment, price_list, price_per_hour, cancellation_terms, ship_owner_id, rating ) values ( nextval('boat_seq_gen'), 'Plavi brod', 'Jahta',150.0, '9832SDS', 90, 40.0, 'Fishfinder', 'Bore Tirica 91', 'Jahta za bogatu bracu',50, 'Ne skaci sa broda', 'Stap za pecanje', 'votkica - 200 din', 330, 'free_cancellation',4, 2.7);
insert into boat (id, name, boat_type, length, engine_number, engine_power,max_speed, navigation_equipment, address, description, capacity, rules, fishing_equipment, price_list, price_per_hour, cancellation_terms, ship_owner_id, rating ) values ( nextval('boat_seq_gen'), 'Brodic', 'Gliser',70.0, '23121SDC', 30, 60.0, 'Sonar', 'Bore Tirica 92', 'NAjjaci brod',50, 'Da se gliserise', 'Stap za pecanje', 'votkica - 200 din', 300, 'free_cancellation',4, 4.6);
insert into boat (id, name, boat_type, length, engine_number, engine_power,max_speed, navigation_equipment, address, description, capacity, rules, fishing_equipment, price_list, price_per_hour, cancellation_terms, ship_owner_id, rating ) values ( nextval('boat_seq_gen'), 'AC4 brod', 'Gusarski brod',200.0, '2132dSD', 0, 30.0, '', 'Karibi 3', 'NAjjaci brod',50, 'Iz igrice Edward kapetan broda', 'Stap za pecanje', 'votkica - 200 din', 220, 'free_cancellation',4, 4.5);
...
insert into fishing_adventure (id, name, address, city, description, max_amount_of_people, behaviour_rules, equipment, price_per_hour, rating, cancelling_precentage, fishing_instructor_id) values ( nextval('fishing_adventure_seq_gen'), 'Pecanje - camac Romeo', 'Palicka 43', 'Subotica', 'Ne propustite divan dan na ovom skromnom camcu', 5, 'Nema pravila', 'Stap za pecanje, udica, mamci', 500, 3, 0, 5);
insert into fishing_adventure (id, name, address, city, description, max_amount_of_people, behaviour_rules, equipment, price_per_hour, rating, cancelling_precentage, fishing_instructor_id) values ( nextval('fishing_adventure_seq_gen'), 'Pecanje - camac Gandalf', 'Strand 2', 'Novi Sad', 'Ne propustite divan dan na ovom carobnom camcu', 7, 'You shall not pass', 'Stap za pecanje, udica, mamci, pice', 600, 4, 0, 5);
insert into fishing_adventure (id, name, address, city, description, max_amount_of_people, behaviour_rules, equipment, price_per_hour, rating, cancelling_precentage, fishing_instructor_id) values ( nextval('fishing_adventure_seq_gen'), 'Pecanje - camac Julija', 'Kneza Lazara 22', 'Beograd', 'Ne propustite divan dan na ovom divnom camcu', 5, 'Nema pravila', 'Stap za pecanje, udica, mamci', 700, 5, 10, 6);
insert into fishing_appointment (id, appointment_start, address, city, duration, max_amount_of_people, appointment_type, available, rating, extra_notes, price, fishing_adventure_id, client_id) values ( nextval('fishing_appointment_seq_gen'), '2022-01-04 12:00:00', 'Palicka, 43', 'Subotica', 4, 8, 'regular', true, 0, 'Nema dodatnih informacija', 2500, 1, 1);
