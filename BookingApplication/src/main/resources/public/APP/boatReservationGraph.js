Vue.component("BoatReservationGraph", {
    data: function() {
        return {
            activeUser:"",
			chartInfo:[],
	...
	weekFormat() {
	    ...
	    axios
        	.get('/boatAppointments/getBoatReservationChartsWeek/' + instructorsId)
	        .then(response => {
	...
	monthFormat() {
		instructorsId = this.activeUser.id 
        axios
        	.get('/boatAppointments/getBoatReservationChartsMonth/' + instructorsId)
	        .then(response => {
	        this.chartInfo = response.data
	        console.log(this.chartInfo)
			this.renderChart(this.makeSeries(this.chartInfo));
	...
	yearFormat() {
		instructorsId = this.activeUser.id 
        axios
        	.get('/boatAppointments/getBoatReservationChartsYear/' + instructorsId)
	        .then(response => {
	        this.chartInfo = response.data
	        console.log(this.chartInfo)
			this.renderChart(this.makeSeries(this.chartInfo));
	...
	allFormat() {
		instructorsId = this.activeUser.id 
        axios
        	.get('/boatAppointments/getBoatReservationCharts/' + instructorsId)
	        .then(response => {
	        this.chartInfo = response.data
	        console.log(this.chartInfo)
			this.renderChart(this.makeSeries(this.chartInfo));
