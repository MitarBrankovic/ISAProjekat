...
insert into cottage (id, name, address, description, rooms_num, beds_num, rules, price_list, cottage_owner_id, rating) values ( nextval('cottage_seq_gen'), 'Crvena vikendica', 'Ledinci', 'Wow wow wow', 4, 4, 'Nema pravila','Parking 100 din', 3, 0);
insert into cottage (id, name, address, description, rooms_num, beds_num, rules, price_list, cottage_owner_id, rating) values ( nextval('cottage_seq_gen'), 'Zelena vikendica', 'Ledinci', 'Wow wow wow', 2, 12, 'Nema pravila','Wifi dan - 100 din', 3, 0);
insert into cottage (id, name, address, description, rooms_num, beds_num, rules, price_list, cottage_owner_id, rating) values ( nextval('cottage_seq_gen'), 'Plava vikendica', 'Ledinci', 'Opis', 6, 4, 'Nema pravila','Dorucak - 30 din', 3, 0);
insert into cottage (id, name, address, description, rooms_num, beds_num, rules, price_list, cottage_owner_id, rating) values ( nextval('cottage_seq_gen'), 'Bela vikendica', 'Ledinci', 'Najs', 1, 3, 'Nema pravila','Rucak - 70 din', 3, 0);
...
insert into boat (id, name, boat_type, length, engine_number, engine_power,max_speed, navigation_equipment, address, description, capacity, rules, fishing_equipment, price_list, cancellation_terms, ship_owner_id, rating ) values ( nextval('boat_seq_gen'), 'Titanik', 'Krstarica',120.0, '123DSAWE32', 75, 30.0, 'Gps', 'Bore Tirica 89', 'NAjjaci brod',50, 'Ne skaci sa broda', 'Stap za pecanje', 'votkica - 200 din', 'free_cancellation',4, 0);
insert into boat (id, name, boat_type, length, engine_number, engine_power,max_speed, navigation_equipment, address, description, capacity, rules, fishing_equipment, price_list, cancellation_terms, ship_owner_id, rating ) values ( nextval('boat_seq_gen'), 'Brod 2', 'Camac',50.0, '213dasdda', 10, 50.0, 'Radio', 'Bore Tirica 90', 'Camac za bleju',50, 'Ne skaci sa broda', 'Stap za pecanje', 'votkica - 200 din', 'free_cancellation',4, 0);
insert into boat (id, name, boat_type, length, engine_number, engine_power,max_speed, navigation_equipment, address, description, capacity, rules, fishing_equipment, price_list, cancellation_terms, ship_owner_id, rating ) values ( nextval('boat_seq_gen'), 'Plavi brod', 'Jahta',150.0, '9832SDS', 90, 40.0, 'Fishfinder', 'Bore Tirica 91', 'Jahta za bogatu bracu',50, 'Ne skaci sa broda', 'Stap za pecanje', 'votkica - 200 din', 'free_cancellation',4, 0);
insert into boat (id, name, boat_type, length, engine_number, engine_power,max_speed, navigation_equipment, address, description, capacity, rules, fishing_equipment, price_list, cancellation_terms, ship_owner_id, rating ) values ( nextval('boat_seq_gen'), 'Brodic', 'Gliser',70.0, '23121SDC', 30, 60.0, 'Sonar', 'Bore Tirica 92', 'NAjjaci brod',50, 'Da se gliserise', 'Stap za pecanje', 'votkica - 200 din', 'free_cancellation',4, 0);
insert into boat (id, name, boat_type, length, engine_number, engine_power,max_speed, navigation_equipment, address, description, capacity, rules, fishing_equipment, price_list, cancellation_terms, ship_owner_id, rating ) values ( nextval('boat_seq_gen'), 'AC4 brod', 'Gusarski brod',200.0, '2132dSD', 0, 30.0, '', 'Karibi 3', 'NAjjaci brod',50, 'Iz igrice Edward kapetan broda', 'Stap za pecanje', 'votkica - 200 din', 'free_cancellation',4, 0);

insert into cottage_appointment (id, appointment_start, duration, max_amount_of_people, appointment_type,  extra_notes, price, cottage_id, client_id) values ( nextval('cottage_appointment_seq_gen'), '2021-12-20 12:00:00', 4, 5, 'quick', 'Nema dodatnih informacija', 5000, 1, 1);
...
insert into fishing_adventure (id, name, address, city, description, photo, max_amount_of_people, behaviour_rules, equipment, price_per_hour, rating, cancelling_precentage, fishing_instructor_id) values ( 1, 'Pecanje - camac Romeo', 'Palicka 43', 'Subotica', 'Ne propustite divan dan na ovom skromnom camcu', 'Nesto', 5, 'Nema pravila', 'Stap za pecanje, udica, mamci', 500, 0, 0, 5);
insert into fishing_adventure (id, name, address, city, description, photo, max_amount_of_people, behaviour_rules, equipment, price_per_hour, rating, cancelling_precentage, fishing_instructor_id) values ( 2, 'Pecanje - camac Gandalf', 'Strand 2', 'Novi Sad', 'Ne propustite divan dan na ovom carobnom camcu', 'Nesto', 7, 'You shall not pass', 'Stap za pecanje, udica, mamci, pice', 600, 0, 0, 5);
insert into fishing_adventure (id, name, address, city, description, photo, max_amount_of_people, behaviour_rules, equipment, price_per_hour, rating, cancelling_precentage, fishing_instructor_id) values ( 3, 'Pecanje - camac Julija', 'Kneza Lazara 22', 'Beograd', 'Ne propustite divan dan na ovom divnom camcu', 'Nesto', 5, 'Nema pravila', 'Stap za pecanje, udica, mamci', 700, 0, 10, 6);
insert into fishing_appointment (id, appointment_start, address, city, duration, max_amount_of_people, appointment_type, available, extra_notes, price, fishing_adventure_id, client_id) values ( nextval('fishing_appointment_seq_gen'), '2021-12-20 12:00:00', 'Palicka, 43', 'Subotica', 4, 8, 'regular', true, 'Nema dodatnih informacija', 2500, 1, 1);
...
insert into fishing_appointment (id, appointment_start, address, city, duration, max_amount_of_people, appointment_type, available, extra_notes, price, fishing_adventure_id, client_id) values ( nextval('fishing_appointment_seq_gen'), '2019-12-23 12:00:00', 'Palicka, 43', 'Subotica', 4, 5, 'regular', true, 'Nema dodatnih informacija', 3200, 2, 1);
