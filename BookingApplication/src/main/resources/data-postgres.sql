...
insert into fishing_appointment (id, appointment_start, address, city, duration, max_amount_of_people, appointment_type, available, rating, extra_notes, price, instructor_profit, system_profit, fishing_adventure_id, client_id, version) values ( nextval('fishing_appointment_seq_gen'), '2022-01-25 12:00:00', 'Palicka, 43', 'Subotica', 4, 8, 'regular', true, 0, 'Nema dodatnih informacija', 2500, 500, 2000, 1, 1, 0);
...
insert into fishing_appointment (id, appointment_start, address, city, duration, max_amount_of_people, appointment_type, available, rating, extra_notes, price, instructor_profit, system_profit, fishing_adventure_id, client_id, version) values ( nextval('fishing_appointment_seq_gen'), '2022-12-22 12:00:00', 'Palicka, 43', 'Subotica', 4, 6, 'quick', true, 0, 'Nema dodatnih informacija', 2500, 500, 2000, 1, null, 0);
