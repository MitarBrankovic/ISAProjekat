...
insert into app_user (id, name, surname, email, password, address, city, country, phone_number, role, verified, ROLES_id, loyalty_points, loyalty_status) values ( nextval('my_user_seq'), 'Dule', 'Dule', 'dule@gmail.com', '111','Palih studenata 2', 'Novi Sad', 'Serbia', '12312312', 'cottage_owner', true, 4, 0, 'regular');
...
insert into cottage_owner (id, cottage_text, rating) values ( 8, 'neki tekst', 3.7);
...
insert into cottage (id, name, address, description, rooms_num, beds_num, rules, price_list, price_per_hour, cottage_owner_id, rating, max_amount_of_people) values ( nextval('cottage_seq_gen'), 'Plava vikendica', 'Ledinci', 'Opis', 6, 4, 'Nema pravila','Dorucak - 30 din', 400, 8, 4.4, 5);
insert into cottage (id, name, address, description, rooms_num, beds_num, rules, price_list, price_per_hour, cottage_owner_id, rating, max_amount_of_people) values ( nextval('cottage_seq_gen'), 'Bela vikendica', 'Ledinci', 'Najs', 1, 3, 'Nema pravila','Rucak - 70 din', 300, 8, 4.1, 8);
...
insert into cottage_appointment (id, appointment_start, duration, max_amount_of_people, appointment_type,  extra_notes, price, owner_profit, system_profit, cottage_id, client_id, version) values ( nextval('cottage_appointment_seq_gen'), '2022-01-26 12:00:00', 4, 5, 'quick', 'Nema dodatnih informacija', 5000, 1000, 4000, 1, 1, 0);
...
insert into fishing_adventure (id, name, address, city, description, photo, max_amount_of_people, behaviour_rules, equipment, price_per_hour, rating, cancelling_precentage, fishing_instructor_id) values ( nextval('fishingadventure_seq_gen'), 'Pecanje - camac Hugo', 'Kneza Lazara 22', 'Beograd', 'Ne propustite divan dan na ovom divnom camcu', 'Kul', 5, 'Nema pravila', 'Stap za pecanje, udica, mamci', 700, 5, 10, 5);


insert into fishing_appointment (id, appointment_start, address, city, duration, max_amount_of_people, appointment_type, available, rating, extra_notes, price, instructor_profit, system_profit, fishing_adventure_id, client_id, version) values ( nextval('fishing_appointment_seq_gen'), '2022-05-25 08:00:00', 'Palicka, 43', 'Subotica', 4, 8, 'regular', true, 0, 'Nema dodatnih informacija', 2500, 500, 2000, 1, 1, 0);
insert into fishing_appointment (id, appointment_start, address, city, duration, max_amount_of_people, appointment_type, available, rating, extra_notes, price, instructor_profit, system_profit, fishing_adventure_id, client_id, version) values ( nextval('fishing_appointment_seq_gen'), '2022-05-26 09:00:00', 'Palicka, 43', 'Subotica', 4, 7, 'quick', true, 0, 'Nema dodatnih informacija', 2500, 500, 2000, 1, 1, 0);
insert into fishing_appointment (id, appointment_start, address, city, duration, max_amount_of_people, appointment_type, available, rating, extra_notes, price, instructor_profit, system_profit, fishing_adventure_id, client_id, version) values ( nextval('fishing_appointment_seq_gen'), '2022-05-22 10:00:00', 'Palicka, 43', 'Subotica', 4, 6, 'quick', true, 0, 'Nema dodatnih informacija', 2500, 500, 2000, 1, null, 0);
insert into fishing_appointment (id, appointment_start, address, city, duration, max_amount_of_people, appointment_type, available, rating, extra_notes, price, instructor_profit, system_profit, fishing_adventure_id, client_id, version) values ( nextval('fishing_appointment_seq_gen'), '2021-05-23 11:00:00', 'Palicka, 43', 'Subotica', 4, 5, 'regular', true, 0, 'Nema dodatnih informacija', 2500, 500, 2000, 1, 2, 0);
insert into fishing_appointment (id, appointment_start, address, city, duration, max_amount_of_people, appointment_type, available, rating, extra_notes, price, instructor_profit, system_profit, fishing_adventure_id, client_id, version) values ( nextval('fishing_appointment_seq_gen'), '2019-05-24 12:00:00', 'Palicka, 43', 'Subotica', 4, 5, 'regular', true, 0, 'Nema dodatnih informacija', 3200, 640, 2560, 2, 1, 0);
insert into fishing_appointment (id, appointment_start, address, city, duration, max_amount_of_people, appointment_type, available, rating, extra_notes, price, instructor_profit, system_profit, fishing_adventure_id, client_id, version) values ( nextval('fishing_appointment_seq_gen'), '2022-05-09 14:00:00', 'Palicka, 43', 'Subotica', 96, 7, 'quick', true, 0, 'Nema dodatnih informacija', 2500, 500, 2000, 1, 1, 0);
