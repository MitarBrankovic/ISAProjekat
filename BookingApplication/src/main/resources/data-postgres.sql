...
insert into boat_appointment (id, appointment_start, duration, max_amount_of_people, appointment_type,  extra_notes, price, boat_id, client_id) values ( nextval('cottage_appointment_seq_gen'), '2022-01-10 12:00:00', 4, 5, 'quick', 'Nema dodatnih informacija', 3000, 5, 1);
